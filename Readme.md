...
| Liu Yifan | General + Orders + Profile | `components/Footer.js`<br>`components/Header.js`<br>`components/Layout.js`<br>`components/Spinner.js`<br>`pages/About.js`<br>`pages/Pagenotfound.js`<br>`pages/user/Orders.js`<br>`pages/user/Profile.js` | `config/db.js`<br>`controllers/authController.js`<br> - `updateProfileController`<br> - `getOrdersController`<br> - `getAllOrdersController`<br> - `orderStatusController`<br>`models/orderModel.js` |
